...
```{r}
# mouse_pkd_sc_sct <- readRDS(here("Datasets", "GSE268494_PKDaggr_GEO_count_SCT.rds"))
# 
# mouse_pkd_sc <- readRDS(here("Datasets", "GSE268494_PKDaggr_GEO_count_RNA.rds"))
# head(mouse_pkd_sc)
```
...
cat("More Abundant", up_genes, "\n")
cat("Less Abundant genes:", down_genes, "\n")
cat("Not significant:", not_sig, "\n")


names(keyvals)[keyvals == "red"] <- paste0("More Abundant (", up_genes, "genes )")
names(keyvals)[keyvals == "blue"] <- paste0("Less Abundant (", down_genes, "genes )")
...
p <- EnhancedVolcano(
  ...
  legendLabSize = 11,
  legendIconSize = 3,
  legendLabels = c( "" , "More Abundant", "Less Abundant")
)
d12_Volcano <- p + theme(
...
cat("More Abundant genes:", up_genes, "\n")
cat("Less Abundant genes:", down_genes, "\n")
cat("Not significant:", not_sig, "\n")
...
p <- EnhancedVolcano(
  ...
  legendLabSize = 11,
  legendIconSize = 3,
  legendLabels = c( "" , "Less Abundant", "More Abundant")
)
d16_Volcano <- p + theme(
  text = element_text(family = "Helvetica Neue Light"),
  plot.title = element_text(family = "Helvetica Neue Light", face = "bold", size = 18),
